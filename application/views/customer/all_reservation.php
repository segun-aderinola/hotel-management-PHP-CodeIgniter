<div class="main">
  <div class="main-inner">
    <div class="container">
      <div class="row">
        <div class="span12">
        	<a href="<?= base_url() ?>customer/active" class="btn btn-small btn-primary"><i class="btn-icon-only icon-ok"></i>CheckedIn Customers</a>
			<h2 style="text-align:center;text-transform:uppercase">All Reservations</h2>
 			...
 			<table class="table table-striped table-bordered" id="tables">
				...
				?>
				  <tr>
				    ...
				    <a href="<?= base_url() ?>reservation/delete/<?=$reservation[$x]->reserve_id?>" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove">Delete </i> </a>
