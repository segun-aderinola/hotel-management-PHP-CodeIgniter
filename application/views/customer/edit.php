		...
		<form action="<?= base_url() ?>customer/edit/<?=$customer->customer_id?>" method="post">
			...
			<div class="add-fields">
				...
				<div class="field">
					...
					<input type="text" id="email" name="email" value="<?=$customer->customer_email?>" placeholder="Email"/>
				</div> <!-- /field -->

			
				<div class="field">
					<label for="customer_country">Country:</label>
					<input type="text" id="city" name="country" value="<?=$customer->customer_country?>" placeholder="Country"/>
				</div> <!-- /field -->
				<div class="field">
					<label for="customer_city">City:</label>
					<input type="text" id="city" name="city" value="<?=$customer->customer_city?>" placeholder="City"/>
				</div> <!-- /field -->
